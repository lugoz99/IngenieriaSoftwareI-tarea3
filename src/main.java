...
public class main {
    ...
    public static void main(String[] args) {
        ...
        controlRegalos.getProductos();
        controlRegalos.getProveedores();
        // CASO 1
        ...
        List<Double> preciosEnvio1 = controlRegalos.calcularPreciosEnvios(productos1);
        ...
        List<Double> preciosEnvio2 = controlRegalos.calcularPreciosEnvios(productos2);
